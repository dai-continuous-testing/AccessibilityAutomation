...
import com.experitest.accessibility.colorthief.MMCQ.CMap;

import javax.imageio.ImageIO;

public class ColorThief {
    public static void main(String...args) throws Exception{
        CMap result = ColorThief.getColorMap(ImageIO.read(new File("results/n.png")), 2);
        int[] rgbFirst = result.vboxes.get(0).avg(false);
        int[] rgbSecond = result.vboxes.get(1).avg(false);
        System.out.println(Arrays.toString(rgbFirst));
        System.out.println(Arrays.toString(rgbSecond));
        double dd = (ContrastChecker.getConstrastRatio(new Color(rgbFirst[0], rgbFirst[1], rgbFirst[2]), new Color(rgbSecond[0], rgbSecond[1], rgbSecond[2])) - 1) /20;
                //ContrastChecker.getConstrastRatio(new Color(rgbFirst[0], rgbFirst[1], rgbFirst[2]), new Color(rgbSecond[0], rgbSecond[1], rgbSecond[2]));
